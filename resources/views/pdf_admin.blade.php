...
<div class="book">
    <div class="page">
        ...
        <div class="datos_entrega">
            ...
            <p><span class="datos_receptor">Código del colaborador :</span><span class="datos_respuesta">{{ $user->codigo_colaborador }}</span></p>
            <p><span class="datos_receptor">Puesto del colaborador :</span><span class="datos_respuesta">{{ $user->puesto_colaborador }}</span></p>
            <p><span class="datos_receptor">Área del colaborador :</span><span class="datos_respuesta">{{ $user->area_colaborador }}</span></p>
            <p><span class="datos_receptor">Fecha de recepción :</span><span class="datos_respuesta">{{ $user->fecha_recepcion }}</span></p>
